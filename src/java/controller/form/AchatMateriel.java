 ...
 *
 * @author nykan
 * SERVLET POUR AFFICHER LA VUE achatMateriel.jsp POUR FAIRE UNE ENTREE DE STOCK
 */
...
public class AchatMateriel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            c.close();
            request.getRequestDispatcher("./pages/achatMateriel.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
