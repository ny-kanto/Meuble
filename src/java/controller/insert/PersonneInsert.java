 ...
 * @author nykan
 */
@WebServlet(name = "PersonneInsert", urlPatterns = { "/PersonneInsert" })
public class PersonneInsert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            personne.setIdposte(idposte);
            personne.setDateembauche(dateembauche);
            personne.insert(c);
            c.close();
            response.sendRedirect("/Furniture/Personne");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
