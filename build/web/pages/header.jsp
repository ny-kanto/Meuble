<%-- 
    Document   : header.jsp
    Created on : 30 janv. 2024, 20:37:04
    Author     : nykan
--%>
        ...
        <ul>
          <li class="nav-item">
            <a href="Statistique">
              ...
              <span class="text">Statistique Vente</span>
            </a>
          </li>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li>
                <a href="Meuble"> Insertion </a>
              </li>
              <li>
                <a href="ListMeuble"> Liste </a>
              </li>
              <li>
                <a href="FabricationMeuble"> Fabrication </a>
              </li>
              <li>
                <a href="ListMeubleBuild"> Liste fabriqués </a>
              </li>
              <li>
                <a href="MeubleMaterielSearch"> Matériaux </a>
              </li>
              <li>
                <a href="MeubleVente"> Vente </a>
              </li>
              <li>
                <a href="Benefice"> Bénéfice </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Matériel Style</span>
            </a>
            <ul id="ddmenu_3" class="collapse dropdown-nav">
              <li>
                <a href="StyleMateriel"> Insertion </a>
              </li>
              <li>
                <a href="StyleMaterielSearch"> Liste </a>
              </li>
              <li>
                <a href="AchatMateriel"> Achat </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_4" class="collapse dropdown-nav">
              <li>
                <a href="alerts.html"> Insertion </a>
              </li>
              <li>
                <a href="ListExperience"> Liste </a>
              </li>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_55" class="collapse dropdown-nav">
              <li>
                <a href="Personne"> Insertion </a>
              </li>
              <li>
                <a href="PersonneExperience"> Liste </a>
              </li>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_5" class="collapse dropdown-nav">
              <li>
                <a href="Client"> Insertion </a>
              </li>
              <li>
                <a href="ListClient"> Liste </a>
              </li>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
          ...
          <li class="nav-item">
            <a href="EtatStock">
              ...
              <span class="text">Etat Stock</span>
            </a>
          </li>
          <span class="divider"><hr /></span>
        </ul>
